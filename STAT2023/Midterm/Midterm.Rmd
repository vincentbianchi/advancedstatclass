...
Answer: 
I prefer the `nn_full` model because it has the lowest Mean Absolute Error. I also like it because it allows for nonlinearity and intercation within the model.
